$(document).ready(function() {
	$('#fullpage').fullpage({
		...
		menu: false,//绑定菜单，设定的相关属性与anchors的值对应后，菜单可以控制滚动，默认为false。
					anchors:['firstPage', 'secondPage','thirdPage','fourthPage','fifthPage'],//anchors定义锚链接，默认为[]
					lockAnchors: false,//是否锁定锚链接，默认为false,设为true后链接地址不会改变
					navigation: true,//是否显示导航，默认为false
					navigationPosition: 'right',//导航小圆点的位置
					navigationTooltips: ['firstSlide', 'secondSlide','thirdPage','fourthPage','fifthPage'],//导航小圆点的提示
					...
					//sectionsColor : ['#000'],//为每个section设置background-color属性
